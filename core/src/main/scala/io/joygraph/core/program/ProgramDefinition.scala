...
case class ProgramDefinition[INPUTFORMAT, I : ClassTag,V : ClassTag,E : ClassTag,M : ClassTag](val inputParser : INPUTFORMAT => (I, I, E), val outputWriter : (Vertex[I,V,E], OutputStream) => Any, val program : Class[_ <: VertexProgramLike[I,V,E,M]]) {
