...
object ProgramDefinition {
  ...
  (inputParser : INPUTFORMAT => (I, I, E),
   ...
   program : Class[_ <: VertexProgramLike[I,V,E,M]]): ProgramDefinition[INPUTFORMAT, I,V,E,M] = new ProgramDefinition[INPUTFORMAT, I,V,E,M](inputParser, outputWriter, program)

}

case class ProgramDefinition[INPUTFORMAT, I : ClassTag,V : ClassTag,E : ClassTag,M : ClassTag](val inputParser : INPUTFORMAT => (I, I, E), val outputWriter : (Vertex[I,V,E,M], OutputStream) => Any, val program : Class[_ <: VertexProgramLike[I,V,E,M]]) {
